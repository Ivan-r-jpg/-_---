...
Аргументами функція приймає тип даних список та крок h типу int, з яким будуть змінюватися аргументи функції.
...
У даній функції задається рівняння дане за умовою 12-го варіанту та вводиться початкова точка з координати на вибір користувача.
"""
